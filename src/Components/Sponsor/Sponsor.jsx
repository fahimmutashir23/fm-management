    ...
    return (
        <div>
            <div className="flex gap-14 bg-bg_nav_footer rounded-2xl justify-center items-center py-5">
                ...
                <a href="#" data-aos = "fade-left"><img src={sponsor_4} alt="" className="w-24 hover:scale-[1.75] transition 1s" /></a>  
                <a href="#" data-aos = "fade-left"><img src={sponsor_5} alt="" className="w-24 hover:scale-[1.75] transition 1s" /></a>  
                <a href="#" data-aos = "fade-left"><img src={sponsor_6} alt="" className="w-24 hover:scale-[1.75] transition 1s" /></a>  
            </div>
        </div>
    );
};
